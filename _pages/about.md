...
Recognising that progress has been hampered by fragmented modelling communities and limited spaces for structured collaboration, we convene researchers and practitioners across disciplines to build shared workflows from data to decision. By bridging existing initiatives such as BES-SIM, Bending the Curve, ISIMIP Biodiversity, FishMIP, and BioFutures, we aim to close critical gaps in the modelling landscape and identify synergistic levers for addressing the coupled biodiversity and climate crisis.
